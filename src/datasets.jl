...
function load_dataset(name::String, split="", dataset_directory="../data")
    if split == ""
...
"""
trim_timeseries(X::Array{T,3}, y::Array{String,1}, ranges::Vector) where {T<:AbstractFloat}

Function for trimming timeseries with stratification over classes
...
function show_stratification(X::Array{T,3}, y::Vector) where {T<:AbstractFloat}
...
function unzip(file::String, exdir="")
...
function download_dataset(name::String, dataset_directory="../data")
